...
void PatternChecker::go(HIR::Crate &crate) {
...
void PatternChecker::visit(Lifetime &) {}

void PatternChecker::visit(LifetimeParam &) {}

void PatternChecker::visit(PathInExpression &path) {}

void PatternChecker::visit(TypePathSegment &) {}

void PatternChecker::visit(TypePathSegmentGeneric &) {}

void PatternChecker::visit(TypePathSegmentFunction &) {}

void PatternChecker::visit(TypePath &) {}

void PatternChecker::visit(QualifiedPathInExpression &) {}

void PatternChecker::visit(QualifiedPathInType &) {}

void PatternChecker::visit(LiteralExpr &) {}

void PatternChecker::visit(BorrowExpr &expr) {
  expr.get_expr().accept_vis(*this);
}

void PatternChecker::visit(DereferenceExpr &expr) {
  expr.get_expr().accept_vis(*this);
}

void PatternChecker::visit(ErrorPropagationExpr &expr) {
  expr.get_expr().accept_vis(*this);
}

void PatternChecker::visit(NegationExpr &expr) {
  expr.get_expr().accept_vis(*this);
}

void PatternChecker::visit(ArithmeticOrLogicalExpr &expr) {
  expr.get_lhs().accept_vis(*this);
  expr.get_rhs().accept_vis(*this);
}

void PatternChecker::visit(ComparisonExpr &expr) {
  expr.get_lhs().accept_vis(*this);
  expr.get_rhs().accept_vis(*this);
}

void PatternChecker::visit(LazyBooleanExpr &expr) {
  expr.get_lhs().accept_vis(*this);
  expr.get_rhs().accept_vis(*this);
}

void PatternChecker::visit(TypeCastExpr &expr) {
  expr.get_expr().accept_vis(*this);
}

void PatternChecker::visit(AssignmentExpr &expr) {
  expr.get_lhs().accept_vis(*this);
  expr.get_rhs().accept_vis(*this);
}

void PatternChecker::visit(CompoundAssignmentExpr &expr) {
  expr.get_lhs().accept_vis(*this);
  expr.get_rhs().accept_vis(*this);
}

void PatternChecker::visit(GroupedExpr &expr) {
  expr.get_expr_in_parens().accept_vis(*this);
}

void PatternChecker::visit(ArrayElemsValues &elems) {
  for (auto &elem : elems.get_values())
    elem->accept_vis(*this);
}

void PatternChecker::visit(ArrayElemsCopied &elems) {
  elems.get_elem_to_copy().accept_vis(*this);
}

void PatternChecker::visit(ArrayExpr &expr) {
  expr.get_internal_elements().accept_vis(*this);
}

void PatternChecker::visit(ArrayIndexExpr &expr) {
  expr.get_array_expr().accept_vis(*this);
  expr.get_index_expr().accept_vis(*this);
}

void PatternChecker::visit(TupleExpr &expr) {
  for (auto &elem : expr.get_tuple_elems())
    elem->accept_vis(*this);
}

void PatternChecker::visit(TupleIndexExpr &expr) {
  expr.get_tuple_expr().accept_vis(*this);
}

void PatternChecker::visit(StructExprStruct &) {}

void PatternChecker::visit(StructExprFieldIdentifier &) {}

void PatternChecker::visit(StructExprFieldIdentifierValue &field) {
  field.get_value().accept_vis(*this);
}

void PatternChecker::visit(StructExprFieldIndexValue &field) {
  field.get_value().accept_vis(*this);
}

void PatternChecker::visit(StructExprStructFields &expr) {
  for (auto &field : expr.get_fields())
    field->accept_vis(*this);
}

void PatternChecker::visit(StructExprStructBase &) {}

void PatternChecker::visit(CallExpr &expr) {
  if (!expr.has_fnexpr())
    return;
...
void PatternChecker::visit(MethodCallExpr &expr) {
...
void PatternChecker::visit(FieldAccessExpr &expr) {
  expr.get_receiver_expr().accept_vis(*this);
}

void PatternChecker::visit(ClosureExpr &expr) {
  expr.get_expr().accept_vis(*this);
}

void PatternChecker::visit(BlockExpr &expr) {
...
void PatternChecker::visit(AnonConst &expr) {
  expr.get_inner_expr().accept_vis(*this);
}

void PatternChecker::visit(ConstBlock &expr) {
  expr.get_const_expr().accept_vis(*this);
}

void PatternChecker::visit(ContinueExpr &) {}

void PatternChecker::visit(BreakExpr &expr) {
  if (expr.has_break_expr())
    expr.get_expr().accept_vis(*this);
}

void PatternChecker::visit(RangeFromToExpr &expr) {
  expr.get_from_expr().accept_vis(*this);
  expr.get_to_expr().accept_vis(*this);
}

void PatternChecker::visit(RangeFromExpr &expr) {
  expr.get_from_expr().accept_vis(*this);
}

void PatternChecker::visit(RangeToExpr &expr) {
  expr.get_to_expr().accept_vis(*this);
}

void PatternChecker::visit(RangeFullExpr &) {}

void PatternChecker::visit(RangeFromToInclExpr &expr) {
  expr.get_from_expr().accept_vis(*this);
  expr.get_to_expr().accept_vis(*this);
}

void PatternChecker::visit(RangeToInclExpr &expr) {
  expr.get_to_expr().accept_vis(*this);
}

void PatternChecker::visit(ReturnExpr &expr) {
  if (expr.has_return_expr())
    expr.get_expr().accept_vis(*this);
}

void PatternChecker::visit(UnsafeBlockExpr &expr) {
  expr.get_block_expr().accept_vis(*this);
}

void PatternChecker::visit(LoopExpr &expr) {
  expr.get_loop_block().accept_vis(*this);
}

void PatternChecker::visit(WhileLoopExpr &expr) {
  expr.get_predicate_expr().accept_vis(*this);
  expr.get_loop_block().accept_vis(*this);
}

void PatternChecker::visit(WhileLetLoopExpr &expr) {
  expr.get_cond().accept_vis(*this);
  expr.get_loop_block().accept_vis(*this);
}

void PatternChecker::visit(IfExpr &expr) {
  expr.get_if_condition().accept_vis(*this);
  expr.get_if_block().accept_vis(*this);
}

void PatternChecker::visit(IfExprConseqElse &expr) {
  expr.get_if_condition().accept_vis(*this);
  expr.get_if_block().accept_vis(*this);
  expr.get_else_block().accept_vis(*this);
}

void PatternChecker::visit(MatchExpr &expr) {
...
void PatternChecker::visit(AwaitExpr &) {
  // TODO: Visit expression
}

void PatternChecker::visit(AsyncBlockExpr &) {
  // TODO: Visit block expression
}

void PatternChecker::visit(InlineAsm &expr) {}

void PatternChecker::visit(LlvmInlineAsm &expr) {}

void PatternChecker::visit(OffsetOf &expr) {}

void PatternChecker::visit(TypeParam &) {}

void PatternChecker::visit(ConstGenericParam &) {}

void PatternChecker::visit(LifetimeWhereClauseItem &) {}

void PatternChecker::visit(TypeBoundWhereClauseItem &) {}

void PatternChecker::visit(Module &module) {
  for (auto &item : module.get_items())
    item->accept_vis(*this);
}

void PatternChecker::visit(ExternCrate &) {}

void PatternChecker::visit(UseTreeGlob &) {}

void PatternChecker::visit(UseTreeList &) {}

void PatternChecker::visit(UseTreeRebind &) {}

void PatternChecker::visit(UseDeclaration &) {}

void PatternChecker::visit(Function &function) {
  function.get_definition().accept_vis(*this);
}

void PatternChecker::visit(TypeAlias &) {}

void PatternChecker::visit(StructStruct &) {}

void PatternChecker::visit(TupleStruct &) {}

void PatternChecker::visit(EnumItem &) {}

void PatternChecker::visit(EnumItemTuple &) {}

void PatternChecker::visit(EnumItemStruct &) {}

void PatternChecker::visit(EnumItemDiscriminant &) {}

void PatternChecker::visit(Enum &) {}

void PatternChecker::visit(Union &) {}

void PatternChecker::visit(ConstantItem &const_item) {
  const_item.get_expr().accept_vis(*this);
}

void PatternChecker::visit(StaticItem &static_item) {
  static_item.get_expr().accept_vis(*this);
}

void PatternChecker::visit(TraitItemFunc &item) {
  if (item.has_definition())
    item.get_block_expr().accept_vis(*this);
}

void PatternChecker::visit(TraitItemConst &item) {
  if (item.has_expr())
    item.get_expr().accept_vis(*this);
}

void PatternChecker::visit(TraitItemType &) {}

void PatternChecker::visit(Trait &trait) {
  for (auto &item : trait.get_trait_items())
    item->accept_vis(*this);
}

void PatternChecker::visit(ImplBlock &impl) {
  for (auto &item : impl.get_impl_items())
    item->accept_vis(*this);
}

void PatternChecker::visit(ExternalStaticItem &) {}

void PatternChecker::visit(ExternalFunctionItem &) {}

void PatternChecker::visit(ExternalTypeItem &) {}

void PatternChecker::visit(ExternBlock &block) {
  // FIXME: Do we need to do this?
  for (auto &item : block.get_extern_items())
    item->accept_vis(*this);
}

void PatternChecker::visit(LiteralPattern &) {}

void PatternChecker::visit(IdentifierPattern &) {}

void PatternChecker::visit(WildcardPattern &) {}

void PatternChecker::visit(RangePatternBoundLiteral &) {}

void PatternChecker::visit(RangePatternBoundPath &) {}

void PatternChecker::visit(RangePatternBoundQualPath &) {}

void PatternChecker::visit(RangePattern &) {}

void PatternChecker::visit(ReferencePattern &) {}

void PatternChecker::visit(StructPatternFieldTuplePat &) {}

void PatternChecker::visit(StructPatternFieldIdentPat &) {}

void PatternChecker::visit(StructPatternFieldIdent &) {}

void PatternChecker::visit(StructPattern &) {}

void PatternChecker::visit(TupleStructItemsNoRest &) {}

void PatternChecker::visit(TupleStructItemsHasRest &) {}

void PatternChecker::visit(TupleStructPattern &) {}

void PatternChecker::visit(TuplePatternItemsNoRest &) {}

void PatternChecker::visit(TuplePatternItemsHasRest &) {}

void PatternChecker::visit(TuplePattern &) {}

void PatternChecker::visit(SlicePatternItemsNoRest &) {}

void PatternChecker::visit(SlicePatternItemsHasRest &) {}

void PatternChecker::visit(SlicePattern &) {}

void PatternChecker::visit(AltPattern &) {}

void PatternChecker::visit(EmptyStmt &) {}

void PatternChecker::visit(LetStmt &stmt) {
  if (stmt.has_init_expr())
    stmt.get_init_expr().accept_vis(*this);
}

void PatternChecker::visit(ExprStmt &stmt) {
  stmt.get_expr().accept_vis(*this);
}

void PatternChecker::visit(TraitBound &) {}

void PatternChecker::visit(ImplTraitType &) {}

void PatternChecker::visit(TraitObjectType &) {}

void PatternChecker::visit(ParenthesisedType &) {}

void PatternChecker::visit(TupleType &) {}

void PatternChecker::visit(NeverType &) {}

void PatternChecker::visit(RawPointerType &) {}

void PatternChecker::visit(ReferenceType &) {}

void PatternChecker::visit(ArrayType &) {}

void PatternChecker::visit(SliceType &) {}

void PatternChecker::visit(InferredType &) {}

void PatternChecker::visit(BareFunctionType &) {}

bool Constructor::is_covered_by(const Constructor &o) const {
...
bool Constructor::operator<(const Constructor &o) const {
  if (kind != o.kind)
    return kind < o.kind;
  ...
  case ConstructorKind::INT_RANGE:
    return int_range.lo < o.int_range.lo ||
           (int_range.lo == o.int_range.lo && int_range.hi < o.int_range.hi);
  case ConstructorKind::STRUCT:
  case ConstructorKind::WILDCARD:
  case ConstructorKind::REFERENCE:
    return false;
...
std::string DeconstructedPat::to_string() const {
...
bool PatOrWild::is_covered_by(const Constructor &c) const {
  if (pat.has_value())
...
std::vector<PatOrWild> PatOrWild::specialize(const Constructor &other_ctor,
                                             int other_ctor_arity) const {
  if (pat.has_value()) {
    ...
    return std::vector<PatOrWild>(other_ctor_arity, PatOrWild::make_wildcard());
  }
}

std::string PatOrWild::to_string() const {
  if (pat.has_value())
...
void PatStack::pop_head_constructor(const Constructor &other_ctor,
...
std::string MatrixRow::to_string() const {
  std::string s;
...
std::vector<PlaceInfo> PlaceInfo::specialize(const Constructor &c) const {
  switch (c.get_kind()) {
  ...
  case Constructor::ConstructorKind::VARIANT: {
    ...
    case TyTy::ADTType::ADTKind::TUPLE_STRUCT: {
      TyTy::VariantDef *variant = adt->get_variants().at(c.get_variant_index());
...
Matrix Matrix::specialize(const Constructor &ctor) const {
...
std::string WitnessPat::to_string() const {
...
void WitnessMatrix::apply_constructor(const Constructor &ctor,
...
void WitnessMatrix::extend(const WitnessMatrix &other) {
...
static DeconstructedPat lower_tuple_pattern(Resolver::TypeCheckContext *ctx,
  ...
  case HIR::TupleStructItems::ItemType::HAS_REST: {
    ...
    for (auto &pattern_member : items_has_rest.get_lower_patterns()) {
      fields.push_back(
          lower_pattern(ctx, *pattern_member,
                        variant->get_fields().at(i++)->get_field_type()));
    }
    while (i <
           variant->num_fields() - items_has_rest.get_upper_patterns().size()) {
      fields.push_back(DeconstructedPat::make_wildcard(pattern.get_locus()));
      i++;
    }
...
static DeconstructedPat lower_struct_pattern(Resolver::TypeCheckContext *ctx,
                                             HIR::StructPattern &pattern,
                                             TyTy::VariantDef *variant,
                                             Constructor ctor) {
  int arity = variant->get_fields().size();

  // Initialize all field patterns to wildcard.
  std::vector<DeconstructedPat> fields = std::vector<DeconstructedPat>(
      arity, DeconstructedPat::make_wildcard(pattern.get_locus()));
  ...
  for (auto &elem : elems.get_struct_pattern_fields()) {
    ...
    case HIR::StructPatternField::ItemType::IDENT: {
      ...
      int field_idx = field_map.at(ident->get_identifier().as_string());
      fields.at(field_idx) =
    ...
    case HIR::StructPatternField::ItemType::IDENT_PAT: {
      ...
      int field_idx = field_map.at(ident_pat->get_identifier().as_string());
      fields.at(field_idx) =
          lower_pattern(ctx, ident_pat->get_pattern(),
...
// Helper to parse integer literals while handling Rust specifics like
// underscores and type suffixes, which std::strtoll does not handle.
static bool parse_check_literal(const std::string &s, int64_t &out_value) {
  if (s.empty())
    return false;
  ...
  for (size_t i = offset; i < s.length(); i++) {
    ...
    if (base == 10)
      is_valid_digit = (c >= '0' && c <= '9');
    else if (base == 16)
      is_valid_digit = (c >= '0' && c <= '9') || (c >= 'a' && c <= 'f') ||
                       (c >= 'A' && c <= 'F');
    else if (base == 8)
      is_valid_digit = (c >= '0' && c <= '7');
    else if (base == 2)
      is_valid_digit = (c == '0' || c == '1');
  ...
  char *endptr = nullptr;
  errno = 0;
  // Use unsigned parsing to handle u64 literals correctly without ERANGE.
  // We cast to int64_t to store bitwise representation in the IntRange.
  unsigned long long tmp_value =
      std::strtoull(clean_digits.c_str(), &endptr, base);
  out_value = static_cast<int64_t>(tmp_value);

  return !(*endptr != '\0' || errno == ERANGE);
}

static DeconstructedPat lower_literal_pattern(Resolver::TypeCheckContext *ctx,
                                              HIR::LiteralPattern &lit_pattern,
                                              TyTy::BaseType *scrutinee_ty) {
  HIR::Literal &literal = lit_pattern.get_literal();
  location_t locus = lit_pattern.get_locus();

  int64_t value = 0;
  switch (literal.get_lit_type()) {
  case HIR::Literal::LitType::INT: {
    if (!parse_check_literal(literal.as_string(), value)) {
      return DeconstructedPat::make_wildcard(locus);
    }
  } break;
  ...
  case HIR::Literal::LitType::CHAR: {
    ...
    if (s.empty())
      ...
      case 'u':
      case 'x':
        rust_sorry_at(locus, "unicode/hex escape patterns not yet "
                             "supported for exhaustiveness checks");
        return DeconstructedPat(Constructor::make_int_range(0, 0), 0, {},
                                locus);
      default:
        value = (int64_t)s[1];
        break;
      ...
      // Multi-byte Unicode character not supported yet
      rust_sorry_at(locus, "unicode characters not yet "
                           "supported for exhaustiveness checks");
      return DeconstructedPat::make_wildcard(locus);
    }
  } break;
...
static DeconstructedPat lower_pattern(Resolver::TypeCheckContext *ctx,
  ...
  case HIR::Pattern::PatternType::LITERAL: {
    ...
    return lower_literal_pattern(ctx, lit_pattern, scrutinee_ty);
  } break;
...
split_constructors(std::vector<Constructor> &ctors, PlaceInfo &place_info) {
  ...
  if (all_wildcard)
    return std::make_pair(std::set<Constructor>({Constructor::make_wildcard()}),
                          std::set<Constructor>());
...
static void emit_exhaustiveness_error(Resolver::TypeCheckContext *ctx,
                                      HIR::MatchExpr &expr,
                                      WitnessMatrix &witness) {
  TyTy::BaseType *scrutinee_ty;
  ...
  if (!witness.empty()) {
    ...
    rust_error_at(expr.get_scrutinee_expr().get_locus(),
                  "non-exhaustive patterns: %s not covered", buf.str().c_str());
  } else {
